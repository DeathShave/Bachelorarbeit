...
%%% Einstellungen für die Tabellen und Figuren
% Abstand zwischen Caption (steht bei KOMA hier meist über der Tabelle) und Tabelleninhalt
\usepackage{caption}
...
%
% Bibtex-Dateien mit den Quellenangaben zur Arbeit
\addbibresource{references/references.bib}
\addbibresource{references/Abbildungsverzeichnis.bib}
...
\lstset{
	...
	% UTF-8-Umlaute in Code-Kommentaren (z.B. app.py, code_train.py im Anhang):
	% "listings" verarbeitet inputenc-UTF-8 nicht nativ, daher explizite Literate-Tabelle.
	literate=%
		{Ä}{{\"A}}1 {Ö}{{\"O}}1 {Ü}{{\"U}}1
		{ä}{{\"a}}1 {ö}{{\"o}}1 {ü}{{\"u}}1
		{ß}{{\ss}}1 {µ}{{$\mu$}}1 {×}{{$\times$}}1
}
